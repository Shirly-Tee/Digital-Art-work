...
export const Creator = () => {
  return (
    <div className="Featured  bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5 ">
      ...
      <div className="create-people flex flex-col md:flex-row gap-4 w-full">
        {creators.map((creator, index) => (
          <div
            key={index}
            className="people flex flex-row w-full  items-center md:w-[40%] lg-w[30%] xl:w-[23%]bg-[#011e3e] p-10 text-white gap-3 bg-[#011e3e]"
          >
            <img
