  ...
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5    ">
      ...
      <div className="art flex flex-col lg:flex-row">
        <div className="art-all flex flex-col lg:w-[30%] bg-[#011e3e] rounded-[20px] p-8">
          <div className="art-image  relative ">
            <img
              ...
              alt=""
            />
            <p className="absolute bg-[#1eb1fa] px-4  py-3 bottom-14 left-14 rounded-md text-white font-medium">
              06 : 13 : 53
            </p>
          </div>
