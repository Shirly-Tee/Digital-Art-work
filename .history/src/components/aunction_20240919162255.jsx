...
export const Aunction = () => {
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5    ">
      ...
      <div className="art flex flex-col lg:flex-row gap-6 justify-center w-full">
        <div className="art-all flex flex-col w-full lg:w-[48%] xl:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
        ...
        {/* art2 */}
        <div className="art-all flex flex-col xl:w-[32%] lg:w-[48%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
          <div className="art-image  relative ">
            <img
              className="p-2 rounded-[20px]"
