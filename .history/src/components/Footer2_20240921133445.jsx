...
const Footer2 = () => {
  return (
    <div className="flex flex-col md:flex-row text-white py-10 w-full px-5 justify-center items-center md:items-start md:justify-between gap-y-6 text-[16px]">
      <div className="left flex flex-col md:flex-row items-center">
        <p>Crypto all Right Reserved. Designed by </p>
        <a className="ml-2 text-[#009fed]" href="#">
          Templatecoder.com
        </a>
      </div>
