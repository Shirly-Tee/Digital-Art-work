...
const Sell = () => {
  return (
    <div className="sell bg-[#00112b] flex flex-col px-6 w-full py-12 lg:px-12 gap-5 ">
      ...
      <div className="create text-white flex flex-col md:flex-row w-full flex-wrap">
        {nfts.map((nft, index) => (
          <div
            key={index}
            className="  bg-[#011631] md:basis-[45%] flex flex-col"
          >
            <img className=" rounded-md flex " src={nft.image} alt="" />
