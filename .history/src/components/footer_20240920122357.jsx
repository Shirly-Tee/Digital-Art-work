...
const Footer = () => {
  return (
    <div className="footer flex flex-col bg-[#011631] w-full px-10 py-10  md:flex-row flex-wrap">
      <div className="footer-1 flex flex-col  text-white w-full md:basis-[45%] lg:basis-[24%]">
      ...
      <div className="footer-2 flex flex-col gap-x-5 text-white w-full md:basis-[45%] lg:basis-[24%]">
