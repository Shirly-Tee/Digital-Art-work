...
const Blog = () => {
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5">
      ...
      <div className="blog flex flex-col md:flex-row gap-6 justify-center">
        {/* blog1 */}
        <div className="blog-all flex-wrap w-full md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] pb-6 gap-2 text-white">
        ...
        {/* blg2 */}
        <div className="blog-all md:hidden  lg:flex flex-col lg:w-[32%] bg-[#011e3e] rounded-[20px] pb-6 gap-2 text-white">
