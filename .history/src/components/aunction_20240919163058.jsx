  ...
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5    ">
      ...
      <div className="art flex flex-col lg:flex-row gap-6 justify-center w-full">
        <div className="art-all flex flex-col w-full lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
          ...
          <div className="likes flex flex-row items-center text-white gap-2">
