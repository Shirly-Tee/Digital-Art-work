...
export const Creator = () => {
  return (
    <div className="Featured  bg-[#00112b] flex flex-col px-4 md:px-8 w-full py-12 lg:px-12 gap-8">
      ...
      <div className="live flex flex-row gap-y-10 items-center">
      ...
      <div className="create-people flex flex-col gap-y-4 w-full flex-wrap md:flex-row justify-between">
