...
export const Creator = () => {
  return (
    <div className="Featured  bg-[#00112b] flex flex-col px-14 w-full py-12 lg:px-12 gap-8">
      ...
      <div className="create-people flex flex-col gap-4 w-full flex-wrap md:flex-row justify-between">
        {creators.map((creator, index) => (
          <div
            key={index}
            className="people flex flex-row basis-full justify-center items-center md:basis-[45%] lg:basis-[30%] xl:basis-[23%]  px-4 py-6 text-white gap-3 lg:gap-2 bg-[#011e3e] rounded-md"
          >
            <img
