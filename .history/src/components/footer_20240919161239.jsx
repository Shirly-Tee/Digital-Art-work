...
const Footer = () => {
  return (
    <div className="footer flex flex-col md:flex-row bg-[#011631] w-full px-10 py-10 gap-6 md:justify-between flex-wrap ">
      <div className="footer-1 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[25%]">
      ...
      <div className="footer-2 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[25%]">
      ...
      <div className="footer-3 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[25%]">
      ...
      <div className="footer-4 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[25%]">
