export const Hero = () => {
  return (
    <div className="hero flex flex-col md:flex-row w-full justify-center items-center gap-6 px-6 ">
      <div className="hero-left flex flex-col mb-4 md:w-[48%] gap-4 pt-8">
        <h1 className="font-[10px] font-medium md:font-semibold">
        ...
        <div className="hero-lft-lt flex flex-row">
          <p className="place w-fit bg-black">PLACE A BID</p>
