    ...
    <div className="container hero flex flex-col lg:flex-row w-full justify-center items-center gap-6 xl:px-6 h-screen">
      ...
      <div className="hero-right lg:w-[48%] px-3 py-6 relative">
        <img
          ...
          alt="img"
        />
        <div className="name flex w-fit flex-row justify-normal items-center gap-3 bg-[#080843] px-6 py-4 absolute bottom-10 left-6">
          <div className="img-wrapper border-[#009fed] border-2 rounded-full ">
            <img
          ...
          <div className="nam-lft text-white">
            <h4>Walls color Today</h4>
            <p>
              Created by <span>Smith</span>
            </p>
          </div>
        </div>
      </div>
