  ...
  return (
    <div className="hero flex flex-col md:flex-row w-full justify-center items-center gap-6 px-6 ">
      <div className="hero-left flex flex-col mb-4 md:w-[48%] gap-4 md:gap-10 pt-8 text-white">
        <h1 className=" text-center md:text-left md:font-semibold">
        ...
        <div className="hero-lft-lt flex flex-row justify-center md:justify-start">
          <p className="place w-fit px-4 py-3  bg-[#009fed]">PLACE A BID</p>
          <p className="view w-fit px-4 py-3 ">VIEW ARTWORK</p>
        </div>
      </div>
