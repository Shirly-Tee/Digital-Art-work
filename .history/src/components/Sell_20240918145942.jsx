...
const Sell = () => {
  return (
    <div className="sell bg-[#00112b] flex flex-col px-6 w-full py-12 lg:px-12 gap-5 ">
      ...
      <div className="create text-white flex flex-col md:flex-row w-full flex-wrap gap-x-4">
        {nfts.map((nft, index) => (
          <div
            key={index}
            className="  bg-[#011631] md:basis-[48%] flex flex-col"
          >
            <img
              className=" rounded-md flex h-[20px] w-[20px] "
              src={nft.image}
              alt=""
            />
