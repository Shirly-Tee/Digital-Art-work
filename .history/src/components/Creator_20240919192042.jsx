    ...
    <div className="Featured  bg-[#00112b] flex flex-col px-4  w-full py-12 lg:px-12 gap-8">
      ...
      <div className="create-people flex flex-col gap-y-4 md:gap-x-[7px] basis-full flex-wrap md:flex-row">
        {creators.map((creator, index) => (
          <div
            key={index}
            className="people flex flex-row basis-full items-center md:basis-[48%] lg:basis-[32.5%] xl:basis-[24.5%]  px-4 py-6 text-white gap-3 lg:gap-2 bg-[#011e3e] rounded-md"
          >
            <img
