    ...
    <div className="collection bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5 ">
      ...
      <div className="create-people flex flex-col w-full flex-wrap md:flex-row">
        {populars.map((popular, index) => (
          <div
            key={index}
            className="people flex flex-row basis-full items-center md:basis-[49%] lg:basis-[32.5%] xl:basis-[24.5%]  px-4 py-6 text-white lg:gap-2 bg-[#011e3e] rounded-md people group relative "
          >
