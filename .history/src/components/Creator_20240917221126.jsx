...
export const Creator = () => {
  return (
    <div className="Featured  bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5 ">
      ...
      <div className="create-people flex flex-col bg-{#00112b} gap-4 w-full flex-wrap md:flex-row">
        {creators.map((creator, index) => (
          <div
            key={index}
            className="people flex flex-row w-full  items-center md:w-[45%] lg:w-[30%] xl:w-[23%]  p-10 text-white gap-3 bg-[#011e3e]"
          >
            <img
