...
const Footer = () => {
  return (
    <div className="footer flex flex-col bg-[#011631] w-full px-10 py-10  md:flex-row flex-wrap gap-0">
      ...
      <div className="footer-4 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:w-fit">
