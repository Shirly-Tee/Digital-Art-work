    ...
    <div className="Featured  bg-[#00112b] flex flex-col px-14 w-full py-12 lg:px-12 gap-8">
      ...
      <div className="create-people flex flex-col gap-4 w-full flex-wrap md:flex-row">
        {creators.map((creator, index) => (
          <div
            key={index}
            className="people flex flex-row w-full justify-center items-center md:w-[45%] lg:w-[30%] xl:w-[23%]  px-4 py-6 text-white gap-3 lg:gap-1 bg-[#011e3e] rounded-md"
          >
            <img
            ...
            <p className="hover: color-#009fed">{creator.value}</p>
          </div>
        ))}
      </div>
    </div>
