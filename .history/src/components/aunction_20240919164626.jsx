  ...
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5    ">
      ...
      <div className="art flex flex-col md:flex-row gap-6 justify-center w-full">
        <div className="art-all flex flex-col w-full md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
        ...
        {/* art2 */}
        <div className="art-all hidden md:flex flex-col md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
        ...
        {/* art3 */}
        <div className="art-all flex flex-col md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
          <div className="art-image w-full relative ">
            <img
              className="p-2 rounded-[20px]"
