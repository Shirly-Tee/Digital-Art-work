...
const Footer = () => {
  return (
    <div className="footer flex flex-col bg-[#011631] w-full px-10 py-10  md:flex-row flex-wrap  justify-between border-b-2 border-opacity-10">
      <div className="footer-1 mb-10 md:mb-0 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[24%]">
        <img className="w-[70%]" src="/src/assets/images/logo.png" alt="" />
      ...
      <div className="footer-2 mb-10 md:mb-0 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[24%]">
      ...
      <div className="footer-3 mb-10 md:mb-0 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[24%]">
      ...
      <div className="footer-4 mb-10 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[24%]">
