    ...
    <div className="container hero flex flex-col lg:flex-row w-full justify-center items-center gap-6 xl:px-6 h-screen">
      ...
      <div className="hero-right lg:w-[48%] px-3 py-6">
        <img
          ...
          alt="img"
        />
        <div className="name flex w-full flex-row justify-normal items-center gap-3">
          <div className="img-wrapper rounded h-[50px] w-[50px]">
            <img src="/src/assets/images/home-creator-1.jpg" alt="img" />
          </div>
