...
export const Aunction = () => {
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5    ">
      ...
      <div className="art flex flex-col md:flex-row gap-6 justify-center w-full">
        <div className="art-all flex-wrap w-full md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
          <div className="art-image w-full relative">
            <img
          ...
          <div className="likes flex flex-row justify-between items-center text-white gap-2">
            <div className="img-wrapper flex flex-row items-center text-white gap-2 p-1 ">
              <img
                ...
                src="/src/assets/images/home-creator-2.jpg "
                alt="img"
              />
        ...
        {/* art2 */}
        <div className="art-all md:hidden  lg:flex flex-row md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
          <div className="art-image  relative w-full ">
            <img
              className="p-2 rounded-[20px]"
              src="/src/assets/images/auction-2.jpg"
              alt=""
            />
            <p className="absolute bg-[#1eb1fa] px-4  py-3 bottom-10 left-10 rounded-md text-white font-medium">
              06 : 13 : 53
          ...
          <p className="text-[20px]">The Beautiful Fish Art</p>
          <div className="art-last flex justify-between bg-[#002248] px-4 py-3 rounded-sm">
            <p className="text-[18px">Current Bid</p>
            <p>0.57 ETH</p>
          </div>
        ...
        {/* art3 */}
        <div className="art-all w-full flex-wrap md:w-[48%] lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-4 text-white">
          <div className="art-image w-full relative ">
            <img
              className="p-2 rounded-[20px]"
              src="/src/assets/images/auction-3.jpg"
              alt=""
            />
            <p className="absolute bg-[#1eb1fa] px-4  py-3 bottom-10 left-10 rounded-md text-white font-medium">
              04 : 10 : 50
          ...
          <div className="likes flex flex-row justify-between items-center text-white gap-2">
            <div className="img-wrapper flex flex-row items-center text-white gap-2 p-1 ">
              <img
                className="rounded-full border-[#009fed] border-2 "
                src="/src/assets/images/home-creator-3.jpg "
                alt="img"
              />
          ...
          <p className="text-[20px]">The Art Of Mountains</p>
          <div className="art-last flex justify-between bg-[#002248] px-4 py-3 rounded-sm">
            <p className="text-[18px">Current Bid</p>
            <p>0.68 ETH</p>
          </div>
