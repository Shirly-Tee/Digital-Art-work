...
const Footer = () => {
  return (
    <div className="footer flex flex-col md:flex-row bg-[#011631] w-full px-10 py-10 justify-between">
      <div className="footer-1 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[33%] xl:basis-[24%] mr-[30px]">
      ...
      <div className="footer-2 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[33%] xl:basis-[24%]mr-[30px]">
