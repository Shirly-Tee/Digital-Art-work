...
const Footer = () => {
  return (
    <div className="footer flex flex-col md:flex-row bg-[#011631] w-full px-10 py-10 justify-between border-b-2 border-b-[#1eb1fa]">
      <div className="footer-1 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[33%] xl:basis-[24%] mr-[70px]">
