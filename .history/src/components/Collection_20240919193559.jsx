      ...
      <div className="create-people flex flex-col w-full flex-wrap md:flex-row">
        {populars.map((popular, index) => (
          ...
          >
            ...
            <div className=" flex-col opacity-0  bg-[#011631] px-12 py-3 absolute bottom-16 ease-in-out hidden group-hover:flex group-hover:opacity-100  group-hover:duration-1000 left-10">
