  ...
  return (
    <div className="aunction bg-[#011631] flex flex-col px-6 w-full py-12 lg:px-12 gap-5    ">
      ...
      <div className="art flex flex-col lg:flex-row">
        <div className="art-all flex flex-col lg:w-[32%] bg-[#011e3e] rounded-[20px] p-6 gap-3 text-white">
          ...
          <div className="likes flex flex-row justify-between items-center text-white gap-2">
            <div className="img-wrapper flex flex-row items-center text-white gap-2 ">
              <img
                className="rounded-full border-[#009fed] border-2 p-2"
          ...
          <p className="text-[20px] font-semibold">The Cubic Universe Art</p>
        </div>
      </div>
    </div>
  );
