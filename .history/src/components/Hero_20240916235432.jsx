export const Hero = () => {
  return (
    <div className="container hero flex flex-col lg:flex-row w-full justify-center items-center lg:justify-between gap-6 px-6 ">
      <div className="hero-left flex flex-col mb-4 lg:w-[48%] gap-4 md:gap-10 pt-8 text-white">
        <h1 className=" text-2xl md:text-4xl lg:text-6xl text-center md:text-left md:text-semibold">
      ...
      <div className="hero-right lg:w-[48%]">
