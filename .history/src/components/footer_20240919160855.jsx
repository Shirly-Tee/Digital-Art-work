...
const Footer = () => {
  return (
    <div className="footer flex flex-col md:flex-row bg-[#011631] w-full px-10 py-10 gap-6 md:justify-between flex-wrap ">
      <div className="footer-1 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[24%] lg:mr-[70px]">
      ...
      <div className="footer-3 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[33%]">
      ...
      <div className="FOOTER-4 footer-1 flex flex-col gap-y-5 text-white w-full md:basis-[45%] lg:basis-[24%]">
        <p className="text-[30px] font-bold">Latest Update</p>
        <form className="bg-[#011e3e] py-4 px-4" action="#">
          <input
