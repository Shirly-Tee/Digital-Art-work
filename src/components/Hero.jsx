const heros = [
  {
    image: "/src/assets/images/home-img-1.jpg",
    person: "/src/assets/images/home-creator-1.jpg",
    walls: "Wall Color",
    name: " smith",
  },
];
...
export const Hero = () => {
  return (
    <div className="container hero flex flex-col lg:flex-row w-full justify-center items-center gap-6 xl:py-10 lg:px-12">
      <div className="hero-left flex flex-col mb-4 lg:w-[48%] gap-8 md:gap-10 md:pt-8 text-white my-20 md:my-0 mx-10 md:mx-0">
        <h1 className=" text-4xl md:text-4xl lg:text-6xl text-center lg:text-left md:text-semibold">
      ...
      {heros.map((hero, index) => (
        <div key={index} className="hero-right lg:w-[48%] px-3 py-6 relative">
          <img className=" rounded-lg border-0" src={hero.image} alt="img" />
          <div className="name flex w-fit flex-row justify-normal items-center gap-3 bg-[#080843] px-5 py-4 absolute bottom-14 left-10 rounded-md">
            ...
            <div className="nam-lft text-white">
              <h3 className="text-[17px]">{hero.walls}</h3>
